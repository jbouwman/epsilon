...
(defvar *work-directory* nil
  "When bound, temp-directory/make-temp-path allocate here instead of system temp.")
...
(defun temp-directory ()
  "Get system temporary directory as path.
   When *work-directory* is bound, uses that instead of system temp."
  (if *work-directory*
      (make-path *work-directory*)
      (make-path

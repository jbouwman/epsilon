...
(define-unibyte-decoder :iso-8859-2 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-2-to-unicode+ (the u8 (- octet #xa0)))))
...
(define-unibyte-decoder :iso-8859-3 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-3-to-unicode+ (the u8 (- octet #xa0)))))
...
(define-unibyte-decoder :iso-8859-4 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-4-to-unicode+ (the u8 (- octet #xa0)))))
...
(define-unibyte-decoder :iso-8859-5 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-5-to-unicode+ (the u8 (- octet #xa0)))))
...
(define-unibyte-decoder :iso-8859-6 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-6-to-unicode+ (the u8 (- octet #xa0)))))
...
(define-unibyte-decoder :iso-8859-7 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-7-to-unicode+ (the u8 (- octet #xa0)))))
...
(define-unibyte-decoder :iso-8859-8 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-8-to-unicode+ (the u8 (- octet #xa0)))))
...
(define-unibyte-decoder :iso-8859-9 (octet)
  (if (< octet #xd0)
      octet
      (svref +iso-8859-9-to-unicode+ (the u8 (- octet #xd0)))))
...
(define-unibyte-decoder :iso-8859-10 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-10-to-unicode+ (the u8 (- octet #xa0)))))
...
(define-unibyte-decoder :iso-8859-13 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-13-to-unicode+ (the u8 (- octet #xa0)))))
...
(define-unibyte-decoder :iso-8859-14 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-14-to-unicode+ (the u8 (- octet #xa0)))))
...
(define-unibyte-decoder :iso-8859-15 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-15-to-unicode+ (the u8 (- octet #xa0)))))
...
(define-unibyte-decoder :iso-8859-16 (octet)
  (if (< octet #xa0)
      octet
      (svref +iso-8859-16-to-unicode+ (the u8 (- octet #xa0)))))

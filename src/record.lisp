...
(defmacro defrecord (name fields &body options)
  "Define a functional record type with named fields.
   ...
   For automatic type-class instance derivation (`:deriving show eq-class
   ...`), use EPSILON.DATA:DEFDATA, which is the supported entry point."

;;;; This module provides networking primitives for macOS and BSD
;;;; systems using kqueue for event notification.
...
(defun make-sockaddr-in (ip-address port)
  ...
  (lib:with-foreign-memory ((addr :char :count 16))
    ...
    (setf (sb-sys:sap-ref-16 (sb-alien:alien-sap addr) 2) 

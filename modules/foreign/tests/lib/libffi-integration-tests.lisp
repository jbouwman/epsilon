...
(defun run-libffi-tests ()
  "Run all libffi integration tests"
  (run-tests 
   'test-libffi-extension-loading
   'test-libffi-basic-function
   'test-libffi-type-constants
   'test-libffi-type-conversion
   'test-libffi-simple-callback
   'test-libffi-callback-types
   'test-libffi-enhanced-make-callback
   'test-libffi-fallback-behavior
   'test-libffi-callback-registry
   'test-libffi-cleanup
   'test-libffi-invalid-types
   'test-libffi-invalid-arguments
   'test-libffi-multiple-callbacks
   'test-libffi-qsort-integration))

;;;; Summary Tests for Different Scenarios

(deftest test-libffi-basic
  "Basic libffi functionality test"
  (run-tests 'test-libffi-extension-loading
                  'test-libffi-basic-function
                  'test-libffi-type-constants))

(deftest test-libffi-types
  "libffi type system tests"
  (run-tests 'test-libffi-type-conversion
                  'test-libffi-invalid-types
                  'test-libffi-invalid-arguments))

(deftest test-libffi-callbacks
  "libffi callback creation tests"
  (run-tests 'test-libffi-simple-callback
                  'test-libffi-callback-types
                  'test-libffi-multiple-callbacks))

(deftest test-libffi-integration
  "libffi integration with existing infrastructure"
  (run-tests 'test-libffi-enhanced-make-callback
                  'test-libffi-fallback-behavior
                  'test-libffi-qsort-integration))

(deftest test-libffi-performance
  "libffi performance and stress tests"
  (run-tests 'test-libffi-callback-registry
                  'test-libffi-cleanup
                  'test-libffi-multiple-callbacks))
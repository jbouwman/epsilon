...
;;;;
;;;; Example:
;;;;   (import (epsilon.encode enc))
;;;;   (enc:base64-encode data)
;;;;   (enc:base16-decode "deadbeef")
;;;;   (enc:encode :base64 data)

(defpackage epsilon.encode
  (:use :cl)
  (:import (epsilon.encode.conditions cond)
            (epsilon.encode.tables tbl)
            (epsilon.encode.base16 b16)
            (epsilon.encode.base32 b32)
            (epsilon.encode.base64 b64)
            (epsilon.encode.bech32 bech)
            (epsilon.encode.streams str))
  (:export
   ;; High-level dispatch
   encode
   decode

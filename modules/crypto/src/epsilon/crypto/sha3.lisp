...
(defpackage epsilon.crypto.sha3
  (:use :cl)
  (:export
   ;; SHA3 one-shot
   ...
   ;; Low-level Keccak sponge primitives (used by cSHAKE / KMAC)
   #:make-keccak-state #:keccak-absorb #:keccak-squeeze))

(in-package :epsilon.crypto.sha3)

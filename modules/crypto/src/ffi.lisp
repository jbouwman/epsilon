...
(ffi:defshared %tls-client-method "TLS_client_method" "libssl" :pointer ()
  :documentation "Get TLS client method")

(ffi:defshared %tls-server-method "TLS_server_method" "libssl" :pointer ()
...
(ffi:defshared %ssl-ctx-use-certificate-file "SSL_CTX_use_certificate_file" "libssl" :int
  (ctx :pointer) (file :string) (type :int)
  :documentation "Load certificate file")

(ffi:defshared %ssl-ctx-use-privatekey-file "SSL_CTX_use_PrivateKey_file" "libssl" :int
  (ctx :pointer) (file :string) (type :int)
  :documentation "Load private key file")

(ffi:defshared %ssl-ctx-check-private-key "SSL_CTX_check_private_key" "libssl" :int
  (ctx :pointer)
  :documentation "Check private key matches certificate")

(ffi:defshared %ssl-ctx-set-verify "SSL_CTX_set_verify" "libssl" :void
  (ctx :pointer) (mode :int) (callback :pointer)
  :documentation "Set verification mode")

(ffi:defshared %ssl-ctx-ctrl "SSL_CTX_ctrl" "libssl" :long

...
(tc:definstance proto:closer cl-stream-reader
  (proto:close* (reader)
...
(tc:definstance proto:reader cl-stream-reader
...
(tc:definstance proto:closer cl-stream-writer
  (proto:close* (writer)
...
(tc:definstance proto:writer cl-stream-writer

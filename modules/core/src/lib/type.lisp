...
;;; For complete binary I/O support, see epsilon.binary-io module.
...
(defun u32set/be (vector index value)
  "Write a 32-bit unsigned integer to VECTOR at INDEX in big-endian order (alternative interface)"
  (declare (type u32 value)
           (type ->u8 vector)
           (type array-index index))
  (setf (aref vector index) (ldb (byte 8 24) value)

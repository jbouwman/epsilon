...
;;;; Moved from epsilon.crypto to epsilon.base64 for better modularity
...
(defun base64-encode (data)
  "Encode byte array or string to base64 string"
  (etypecase data
    (string (string-to-base64-string data))
    ((array (unsigned-byte 8) (*)) (usb8-array-to-base64-string data))))
...
(defun base64-to-octets (string)
  "Decode base64 string to byte array (alias for base64-decode)"
  (base64-string-to-usb8-array string))
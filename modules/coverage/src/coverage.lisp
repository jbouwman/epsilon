...
;;;;
;;;; This module provides code coverage analysis for Epsilon projects,
...
(defpackage epsilon.tool.coverage
   ...
   *source-map*
   ...
   coverage-summary-p
   coverage-summary-total-files
   coverage-summary-covered-files
   coverage-summary-total-lines
   coverage-summary-covered-lines
   coverage-summary-line-coverage-percent
   coverage-summary-total-forms
   coverage-summary-covered-forms
   coverage-summary-form-coverage-percent
   
   ;; Coverage data structures
   make-coverage-file
   coverage-file-p
   coverage-file-pathname
   coverage-file-total-lines
   coverage-file-covered-lines
   coverage-file-line-coverage-percent
   coverage-file-lines
   coverage-file-forms
   ...
   coverage-line-covered-p
   coverage-line-hit-count
   coverage-line-content
   
   make-coverage-form
   coverage-form-p
   coverage-form-start-line
   coverage-form-end-line
   coverage-form-covered-p
   coverage-form-hit-count
